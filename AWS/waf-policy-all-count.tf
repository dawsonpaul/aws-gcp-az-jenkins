...
resource "aws_wafv2_web_acl" "eps-aws-unmanaged-all-count" {
  name        = "eps-eim12345-aws-applicationname-unmanaged-all-count"
  scope       = "REGIONAL"
  ...
  rule {
    name     = "AWS-AWSManagedRulesCommonRuleSet-all-count"
    priority = 100
    ...
    visibility_config {
      cloudwatch_metrics_enabled = true
      metric_name                = "AWS-AWSManagedRulesCommonRuleSet-all-count"
      sampled_requests_enabled   = true
    }
  ...
  rule {
    name     = "AWS-AWSManagedRulesSQLiRuleSet-all-count"
    priority = 120
    ...
    visibility_config {
      cloudwatch_metrics_enabled = true
      metric_name                = "AWS-AWSManagedRulesSQLiRuleSet-all-count"
      sampled_requests_enabled   = true
    }
 ...
 # Production AWSManagedRulesSQLiRuleset
  ...
  rule {
    name     = "AWS-AWSManagedRulesKnownBadInputsRuleSet-all-count"
    priority = 140
    ...
    visibility_config {
      cloudwatch_metrics_enabled = true
      metric_name                = "AWS-AWSManagedRulesKnownBadInputsRuleSet-all-count"
      sampled_requests_enabled   = true
    }
  ...
  rule {
    name     = "AWS-AWSManagedRulesLinuxRuleSet-all-count"
    priority = 160
    ...
    visibility_config {
      cloudwatch_metrics_enabled = true
      metric_name                = "AWS-AWSManagedRulesLinuxRuleSet-all-count"
      sampled_requests_enabled   = true
    }
...
# Production AWSManagedRulesLinuxRuleSet
  ...
  rule {
    name     = "AWS-AWSManagedRulesWindowsRuleSet-all-count"
    priority = 180
    ...
    visibility_config {
      cloudwatch_metrics_enabled = true
      metric_name                = "AWS-AWSManagedRulesWindowsRuleSet-all-count"
      sampled_requests_enabled   = true
    }
  ...
  rule {
    name     = "AWS-AWSManagedRulesPHPRuleSet-all-count"
    priority = 200
    ...
    visibility_config {
      cloudwatch_metrics_enabled = true
      metric_name                = "AWS-AWSManagedRulesPHPRuleSet-all-count"
      sampled_requests_enabled   = true
    }
  ...
  rule {
    name     = "AWS-AWSManagedRulesAdminProtectionRuleSet-all-count"
    priority = 220
    ...
    visibility_config {
      cloudwatch_metrics_enabled = true
      metric_name                = "AWS-AWSManagedRulesAdminProtectionRuleSet-all-count"
      sampled_requests_enabled   = true
    }
  ...
  rule {
    name     = "AWS-AWSManagedRulesWordPressRuleSet-all-count"
    priority = 240
    ...
    visibility_config {
      cloudwatch_metrics_enabled = true
      metric_name                = "AWS-AWSManagedRulesWordPressRuleSet-all-count"
      sampled_requests_enabled   = true
    }
