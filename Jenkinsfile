    ...
    stages {
        ...
        stage('Run GoTestWAF Report') {
            steps {
                ...
                sh "docker run --rm --network='host' -v $PWD/var/lib/jenkins/workspace/waf-lab-pipeline_main/reports:/app/reports wallarm/gotestwaf  --skipWAFBlockCheck  --skipWAFIdentification  --url ${waflab_appgw_url}/#/ " 
